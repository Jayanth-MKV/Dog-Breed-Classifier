...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['pct_correct_dogs']=pct_corr_dog
    results_stats_dic['pct_correct_notdogs']=pct_corr_notdog
    results_stats_dic['pct_correct_breed']=pct_corr_breed
